...
public class DriverDelegateWrapper implements DriverDelegate {
    ...
    @Override
    public List<JobDetail> selectJobDetails(Connection conn, GroupMatcher<JobKey> matcher, ClassLoadHelper loadHelper) throws ClassNotFoundException, IOException, SQLException {
        return delegate.selectJobDetails(conn, matcher, loadHelper);
    }
    ...
    public JobDetail selectJobForTrigger(Connection conn, ClassLoadHelper loadHelper, TriggerKey triggerKey,
                                         boolean loadJobClass) throws ClassNotFoundException, SQLException, IOException {
    ...
    @Override
    public List<OperableTrigger> getTriggersByJobAndTriggerGroup(Connection conn, GroupMatcher<JobKey> jobMatcher, GroupMatcher<TriggerKey> triggerMatcher) throws SQLException, ClassNotFoundException, IOException, JobPersistenceException {
        return delegate.getTriggersByJobAndTriggerGroup(conn, jobMatcher, triggerMatcher);
    }
